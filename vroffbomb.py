...
def menu():
    print(Fore.CYAN + Style.BRIGHT + "fzlbomb: Введите номер:" + Style.RESET_ALL)
    global phone
    phone = input(cursor + Style.RESET_ALL)
    check_number()
    print(Fore.CYAN + Style.BRIGHT + "fzlbomb: Введите количество циклов:" + Style.RESET_ALL)
    global count
    ...
    print(
        Fore.YELLOW
        + Style.BRIGHT
        + f"\nГотово.\nТелефон: {phone}\nКол-во пройденных циклов: {iteration} fzlbomb"
        + Style.RESET_ALL
    )
